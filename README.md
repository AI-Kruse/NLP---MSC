...
- **Releases**: Download the 56MB `.zip` file containing the 98 PDF articles from the [Releases tab](INSERT_LINK_HERE).
...
3. **Data**: Download the article ZIP from the **Releases** section and extract the PDFs into a subfolder named `dokumenter/` (or your specific folder name).
...
> S. M. Kruse, "PDF Full-Text NLP - LDA Pipeline," GitHub, 2026. [Source code]. Available: [Link to this Repo]
